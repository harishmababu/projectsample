...
public class Associate2Visit {
	WebDriver driver;
	public Associate2Visit(WebDriver driver) {
		this.driver=driver;
	}
...
//selecting institution
	public void institution(String  instoption) throws InterruptedException {
